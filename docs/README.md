...
<figure>
  <img src="Architecture.png" width="550" alt="Architecture">
  <figcaption align="center"><i>Note: Hidden layer is configurable in the init_params() function.</i></figcaption>
</figure>
